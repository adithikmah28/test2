...
const DOWNLOAD_SOURCE_URL = 'https://dl.vidsrc.vip/movie/';
...
async function loadDownloadPage() {
    ...
    if (!movieId) {
        displayError("ID film tidak ditemukan.");
        return;
    }
    ...
    const html = `
        <div class="download-card">
            ...
            <div class="download-buttons">
                <a href="${downloadLink}" class="download-button-item" target="_blank">
                    <i class="fas fa-cloud-download-alt"></i> Download Film
                </a>
            </div>
        </div>
    `;
