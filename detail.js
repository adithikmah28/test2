...
function displayHeroDetail(movie) {
    ...
    movieDetailHero.innerHTML = `
        ...
        <div class="detail-box">
            ...
            <div class="action-buttons">
                ...
                <!-- Tombol ini sekarang HANYA menjadi link biasa ke halaman download -->
                <a href="download.html?id=${movie.id}" class="action-btn download-btn">
    ...
    // Hanya ada event listener untuk play dan watchlist
    ...
    // TIDAK ADA event listener untuk download di sini
}
...
// FUNGSI handleDownloadClick SUDAH DIHAPUS DARI SINI
